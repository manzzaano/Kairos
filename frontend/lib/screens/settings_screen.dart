    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            const _Section(title: Strings.profile),
            _Row(label: Strings.username, value: username),
            _Row(label: Strings.email, value: auth.user?.email ?? '—'),
            const SizedBox(height: 32),
            const _Section(title: Strings.preferences),
            const _Row(label: Strings.theme, value: Strings.settingsDark),
            const _Row(label: Strings.language, value: Strings.settingsSpanish),
            const SizedBox(height: 32),
            const _Section(title: Strings.about),
            const _Row(label: Strings.developer, value: Strings.developerSignature),
            const _Row(label: Strings.school, value: Strings.schoolName),
            const _Row(label: Strings.projectType, value: Strings.year),
            const _Row(label: 'VERSIÓN', value: Strings.version),
